...
-- Note: The Orchid theme is now a proper colorscheme accessible via vim.cmd()
-- ============================================================================

-- Load custom Orchid theme (Dark Orchid inspired)
-- vim.cmd("colorscheme orchid")

-- Alternative: Use any installed colorscheme (uncomment one below)
